...
public class ProfileActivityTest {
    ...
    public void profileActivityTest() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.EditTextName),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("Alex"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.EditTextCountry),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
                                0),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("United States"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText15 = onView(
                allOf(withId(R.id.EditTextTextCity),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
                                0),
                        isDisplayed()));
        appCompatEditText15.perform(replaceText("Seattle"),closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText20 = onView(
                allOf(withId(R.id.EditTextWeight),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText20.perform(replaceText("100"), closeSoftKeyboard());
